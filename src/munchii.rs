...
// head forward on a flattened body, feet shuffle
const CRAWL: &[&[&str]] = &[
    &["            __     ", " )        (( o==@  ", " |        (\\_)     ", "  \\__________/     ", "   w  w   w  w     ", "                   "],
    &["            __     ", " |        (( o==@  ", " |        (\\_)     ", "  \\__________/     ", "   w   w  w   w    ", "                   "],
    &["            __     ", " /        (( o==@  ", " |        (\\_)     ", "  \\__________/     ", "    w  w   w  w    ", "                   "],
    &["            __     ", " |        (( o==@  ", " |        (\\_)     ", "  \\__________/     ", "   w  w  w  w      ", "                   "],
    &["            __     ", " \\        (( o==@  ", " |        (\\_)     ", "  \\__________/     ", "  w  w   w  w      ", "                   "],
...
// turned sideways, clinging to the right wall, paws + motion lines drip down
const WALLSLIDE: &[&[&str]] = &[
    &["   __   |", "  (o)   |", "  (\\_)==|", "   ||   |", "   ||  | ", "   ))   |"],
    &["   __  ~|", "  (o)   |", "  (\\_)==|", "   ||   |", "   ||  | ", "   ))   |"],
    &["   __  ~|", "  (o)   |", "  (\\_)  |", "   ||  ~|", "   ||==| ", "   ))   |"],
...
// big fast tail wag, excited eye on the up-beats
const HAPPY: &[&[&str]] = &[
    &["             __    ", " /         (( o==@ ", " |         (\\_)    ", " /____________\\    ", " \\____________/    ", "  n  n      n  n   "],
    &["             __    ", " |         (( ^==@ ", " |         (\\_)    ", " /____________\\    ", " \\____________/    ", "  n  n      n  n   "],
    &["             __    ", " \\         (( o==@ ", " |         (\\_)    ", " /____________\\    ", " \\____________/    ", "  n  n      n  n   "],
