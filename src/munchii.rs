...
// a jump arc: gather, launch, rise, effort, flutter, land. Front paws lift and
// flutter while the body stays a near-full oval (one underscore shorter than the
// standing pose, not the stubby tuck it used to collapse to) so he stays Munchii.
const JUMP: &[&[&str]] = &[
    &["             __    ", " |         (( o==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  w        w       "],
    &["          \\(  )/   ", " |         (( o==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  u        u       "],
    &["         \\(    )/  ", " |         (( o==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  u        u       "],
    &["         /(    )\\  ", " |         (( ^==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  u        u       "],
    &["          \\(  )/   ", " |         (( o==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  n  n      n  n   "],
    &["             __    ", " |         (( o==@ ", " |         (\\_)    ", " /___________\\     ", " \\___________/     ", "  n  n      n  n   "],
];
